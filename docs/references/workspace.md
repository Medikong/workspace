...
이 문서는 `workspace` repo의 설치법, 빠른 시작, 명령, 기준 파일, 실행 환경, 비목표를 모아 둔 레퍼런스입니다.
...
- [신규 참여자 빠른 시작](../onboarding/quickstart.md)
- [repo별 책임 경계](../architecture/repo-boundaries.md)
- [workspace 역할 결정 기록](../adr/0001-use-workspace-as-polyrepo-helper.md)
- [프로젝트 계획 문서 인덱스](../projects_plan/README.md)
