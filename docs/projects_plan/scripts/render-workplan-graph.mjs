...
const workplansDir = path.join(projectDir, "workplans");
const generatedDir = path.join(projectDir, ".generated");
const outputPath = path.join(generatedDir, "workplan-graph.html");
...
<head>
  ...
  <title>KT CloudNative Study Workplan Graph</title>
  <style>
    :root {
      --bg: #f7f3ea;
      --panel: #fffaf1;
...
<body>
  <header>
    <h1>KT CloudNative Study Workplan Graph</h1>
    <p class="lede"><code>workplans/*.yaml</code>을 단일 진실 원천으로 삼아 작업, 의존성, milestone, estimate 흐름을 빠르게 확인하는 로컬 HTML 뷰어입니다. 생성 시각: ${escapeHtml(model.generatedAt)}</p>
  </header>
